...
const Readings = () => {
    ...
    return (_jsxs("div", { className: "w-[21.25rem] md:w-[44rem] lg:w-[58rem] h-[880px] relative bg-white rounded-xl p-4", children: [_jsxs("div", { className: " flex-col justify-start items-start gap-1 inline-flex", children: [_jsx(TitleParts, { title: "Readings" }), _jsx("p", { className: "self-stretch text-stone-500 text-sm font-normal font-Quicksand leading-[17.50px]", children: "17 Published Stories" })] }), _jsx("div", { className: "w-[21.25rem] md:w-[44rem] lg:w-[58rem] h-[41.37rem] grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1  lg:gap-y-6 mt-6 lg:gap-x-4 overflow-y-scroll lg:overflow-hidden justify-center", children: data.map((item) => {
